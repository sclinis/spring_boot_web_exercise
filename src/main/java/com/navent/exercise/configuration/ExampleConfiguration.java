...
public class ExampleConfiguration {
    ...
    public List<Player> initPlayerList() {
        ...
        players.add(new Player(1L,"Lionel","Mesi",LocalDate.of(1987,6,24),30,true));
        players.add(new Player(2L, "Cristiano", "Ronaldo", LocalDate.of(1985, 2, 5),25,false));
        players.add(new Player(3L, "Juan Roman", "Riquelme", LocalDate.of(1978, 6, 24),50,true));
        players.add(new Player(4L, "Lisandro", "Martinez", LocalDate.of(1998, 1, 18),36,true));
        players.add(new Player(5L, "Javier", "Mascherano", LocalDate.of(1984, 6, 8),16,false));
        players.add(new Player(6L, "Sergio", "Aguero", LocalDate.of(1988, 6, 2),23,true));
        players.add(new Player(7L, "Carlitos", "Tevez", LocalDate.of(1984, 2, 5),10,true));
        players.add(new Player(8L, "Franco", "Armani", LocalDate.of(1986, 10, 16),12,false));
